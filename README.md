...
`Happy Creeper` is a Fabric mod for Minecraft `1.21.6` focused on one idea: turn creepers from a survival threat into a real companion you can weaken, tame, heal, recolor, and bring into combat.
